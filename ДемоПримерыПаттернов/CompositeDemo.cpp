...
using namespace std;
/*
Паттерн Composite вводит абстрактный базовый класс Component (Unit) с поведением, 
общим для всех примитивных и составных объектов
*/
// Component 
class Unit
{
public:
    virtual int getStrength() = 0;  // для подсчета разрушающей силы
